...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    const pointerMoveHandler = handlePointerMove as unknown as (ev: MouseEvent) => void;
    const pointerEnterHandler = handlePointerEnter as unknown as (ev: MouseEvent) => void;
    const pointerLeaveHandler = handlePointerLeave as unknown as (ev: MouseEvent) => void;

    // Fixed types for addEventListener
        ...
        <section className="pc-card">
          <div className="pc-inside">
            ...
            <div className="pc-content pc-avatar-content">
               <div className="pc-quote-overlay">
                  <p className="text-white text-xs font-bold leading-relaxed px-12 text-center italic drop-shadow-md">
                    {quote}
                  </p>
               </div>
              <img
